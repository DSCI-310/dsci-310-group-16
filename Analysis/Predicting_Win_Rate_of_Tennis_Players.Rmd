...
knitr::kable(
  head(player_career), 
  caption = "Table 3: Mutated data table used for data processing"
  )
```
...
knitr::kable(
  ...
  caption = "Table 4: Mean Values for each Predictor Variable"
  )
```
...
```{r}
knitr::include_graphics(here::here("data/player-quantitative-predictors.png"))
```
*All Predictor Relationships using ggpairs*
