...
```{r, message=FALSE, warning=FALSE, echo = TRUE}
source(here::here("R/1_load-libraries.R"))
...
atp_df <- read.csv(here::here("data/atp2017-2019-1.csv"))
...
sjPlot::tab_df(
  head(player_career), 
  title = "Table 3: Mutated data table used for data processing"
  )
```
...
sjPlot::tab_df(
  ...
  title = "Table 4: Mean Values for each Predictor Variable"
  )
```
